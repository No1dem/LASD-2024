...
public:
  ...
  inline bool operator!=(const BST& bst) const noexcept {return !(*this == bst);};
  ...
  virtual const BinaryTree<Data>::Node& Root() const override; // Override BinaryTree member
...
protected:
  ...
  virtual NodeLnk* const & FindPointerToMin(NodeLnk* const &) const noexcept; // unmutable version
  virtual NodeLnk*& FindPointerToMin(NodeLnk*&) noexcept; //mutable version

  virtual NodeLnk* const & FindPointerToMax(NodeLnk* const &) const noexcept; // unmutable version
  virtual NodeLnk*& FindPointerToMax(NodeLnk*&) noexcept; //mutable version

  NodeLnk* const & FindPointerTo(NodeLnk* const &,const Data&) const noexcept; //unmutable version
  NodeLnk*& FindPointerTo(NodeLnk* &,const Data&) noexcept;  //mutable version

  virtual NodeLnk* const * FindPointerToPredecessor(NodeLnk* const &, const Data&) const noexcept; //unmutable version
  virtual NodeLnk** FindPointerToPredecessor(NodeLnk*&, const Data&) noexcept;  //mutable version
  
  virtual NodeLnk* const * FindPointerToSuccessor(NodeLnk* const &, const Data&) const noexcept; //unmutable version
  virtual NodeLnk** FindPointerToSuccessor(NodeLnk*&, const Data&) noexcept;  //mutable version
